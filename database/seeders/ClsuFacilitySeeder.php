...
class ClsuFacilitySeeder extends Seeder
{
    ...
    private function facility(
        ...
        return [
            ...
            // External Google Drive folders are intentionally not persisted by the seeder.
            'Reference_URL' => null,
            'Data_Notes' => $notes,
