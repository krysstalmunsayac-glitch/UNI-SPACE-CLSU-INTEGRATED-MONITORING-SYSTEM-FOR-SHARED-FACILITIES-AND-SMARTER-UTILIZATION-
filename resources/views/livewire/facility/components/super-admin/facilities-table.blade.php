<x-ui::card>
    ...
    <x-ui::table :paginate="$this->facilities">
        <x-ui::table.columns>
            ...
            <x-ui::table.column class="min-w-56 whitespace-nowrap" sortable :sorted="$sortBy === 'Status'" :direction="$sortDirection" wire:click="sort('Status')">
                Status
            </x-ui::table.column>
                ...
                <x-ui::table.row wire:key="facility-{{ $facility->FID }}">
                    ...
                    <x-ui::table.cell class="min-w-56">
                        <button
                            ...
                            class="group flex w-full flex-col items-start rounded-xl px-2 py-2 text-left transition hover:bg-zinc-50 focus:outline-none focus:ring-2 focus:ring-emerald-600 focus:ring-offset-2 disabled:cursor-wait disabled:opacity-60 dark:hover:bg-zinc-800 dark:focus:ring-offset-zinc-900"
                        ...
                        >
                            <span
                                @class([
                                    'inline-flex min-w-24 items-center justify-center gap-1.5 whitespace-nowrap rounded-full px-3 py-1 text-xs font-semibold leading-none text-white transition-colors',
                            ...
                            >
                                <span class="size-1.5 rounded-full bg-white/90"></span>
                                {{ $facility->Status ?: 'Not specified' }}
                            </span>
                            @if ($facility->Status === 'Unavailable')
                                <span class="mt-2 grid gap-1.5 border-l-2 border-zinc-200 pl-3 text-[11px] leading-4 dark:border-zinc-700">
                                    ...
                                    <span class="font-semibold text-emerald-700 dark:text-emerald-300">
                                        ...
                                        <span class="block whitespace-nowrap">{{ $facility->Available_At?->format('M j, Y · g:i A') ?? 'Manual activation required' }}</span>
                                    </span>
                                </span>
                            @endif
                        </button>
