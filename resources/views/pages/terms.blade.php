<x-layouts.home.header>
    <section class="border-b border-emerald-900/10 bg-white py-16 dark:border-white/10 dark:bg-zinc-950">
        <div class="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
            <p class="text-sm font-black uppercase tracking-[0.2em] text-emerald-700 dark:text-emerald-300">UNI Space</p>
        ...
        <div class="mx-auto max-w-4xl space-y-5 px-4 sm:px-6 lg:px-8">
            @foreach ([
                ...
                [
                    ...
                    'text' => 'UNI Space must be used only for legitimate campus-related facility reservations. Misuse, false information, duplicate submissions, or attempts to bypass approval workflows may result in request rejection or account review.',
                ],
                [
                    'title' => 'Privacy and Records',
                    'text' => 'Information submitted in UNI Space is used to process reservations, notify users, manage facility schedules, and support administrative reporting. Reservation records may be retained for operational and audit purposes.',
                ],
            ] as $section)
            ...
            <div class="rounded-xl border border-yellow-300 bg-yellow-50 p-6 text-emerald-950 dark:border-yellow-400/40 dark:bg-yellow-400/10 dark:text-yellow-100">
                ...
                <p class="mt-3 leading-7">
                    By creating an account, you confirm that you understand and agree to follow these terms while using UNI Space.
                </p>
            </div>
        </div>
    </section>
