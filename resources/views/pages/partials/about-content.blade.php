        ...
        <div class="mx-auto grid min-h-[520px] max-w-7xl items-center gap-10 px-4 py-16 sm:px-6 lg:grid-cols-[0.95fr_1.05fr] lg:px-8">
            <div>
                ...
                <div class="mt-8 flex flex-wrap gap-3">
                    <a href="#facilities" class="inline-flex items-center justify-center rounded-xl bg-emerald-700 px-6 py-3 text-sm font-bold text-white transition hover:bg-emerald-800">Browse facilities</a>
                    <a href="#calendar" class="inline-flex items-center justify-center rounded-xl border border-emerald-700 px-6 py-3 text-sm font-bold text-emerald-800 transition hover:bg-emerald-50 dark:border-emerald-300 dark:text-emerald-200 dark:hover:bg-zinc-900">
                        View calendar
                        <svg aria-hidden="true" class="ml-2 h-4 w-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    ...
    <section class="bg-white py-20 dark:bg-zinc-950">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="mx-auto max-w-3xl text-center">
                ...
                <p class="mt-5 text-lg leading-8 text-emerald-900/70 dark:text-zinc-300">Replace these sample profiles with the actual project team, office contacts, or system maintainers.</p>
            </div>
